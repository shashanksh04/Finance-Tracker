...
function TabIcon({ label, focused }: { label: string; focused: boolean }) {
  const icons: Record<string, string> = { Dashboard: '🏠', Transactions: '💳', Accounts: '🏦', More: '☰' };
...
function MoreStack() {
  ...
  return (
    <MoreStackNav.Navigator screenOptions={{ headerStyle: { backgroundColor: '#fff' }, headerTintColor: '#0f172a', headerTitleStyle: { fontWeight: '600' } }}>
      <MoreStackNav.Screen name="MoreHome" component={MoreScreen} options={{ headerShown: false }} />
      <MoreStackNav.Screen name="Categories" component={CategoriesScreen} options={{ title: 'Categories' }} />
      <MoreStackNav.Screen name="Budgets" component={BudgetsScreen} options={{ title: 'Budgets' }} />
      <MoreStackNav.Screen name="Goals" component={GoalsScreen} options={{ title: 'Goals' }} />
      <MoreStackNav.Screen name="Bills" component={BillsScreen} options={{ title: 'Bills' }} />
      <MoreStackNav.Screen name="Recurring" component={RecurringScreen} options={{ title: 'Recurring' }} />
      <MoreStackNav.Screen name="Alerts" component={AlertsScreen} options={{ title: 'Alerts' }} />
      <MoreStackNav.Screen name="Analysis" component={AnalysisScreen} options={{ title: 'Analysis' }} />
      <MoreStackNav.Screen name="Copilot" component={CopilotScreen} options={{ title: 'AI Copilot' }} />
      <MoreStackNav.Screen name="CameraOCR" component={CameraOCRScreen} options={{ title: 'Scan Receipt' }} />
      <MoreStackNav.Screen name="Settings" component={SettingsScreen} options={{ title: 'Settings' }} />
